    ...
    <div style="margin-top: 5vh" v-if="dataLoad">
        <div class="btn-group rounded w-50 mt-2" role="group" aria-label="Basic radio toggle button group">
            ...
            <input
                ...
                id="btnPeculiarity"
                autocomplete="off"
                :checked="choosenTree == 'peculiarity'"
                data-bs-target="#carouselUpgrades"
                data-bs-slide-to="4"
            />
            <label
                ...
                @click="
                    {
                        ;(choosenTree = 'peculiarity'), buttonSound()
                    }
                "
            >
                peculiarity
        ...
        <div id="carouselUpgrades" class="carousel slide" data-bs-ride="carousel" data-bs-interval="false">
            <div class="carousel-inner">
                ...
                <div class="carousel-item"><PeculiarityCard :playerProp="player" style="min-height: 70vh" /></div>
                <div class="carousel-item">
...
import PeculiarityCard from '@/components/PeculiarityCard.vue'
