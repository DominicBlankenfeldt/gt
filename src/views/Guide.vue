<template>
  <div class="card" style="margin-top: 10vh">
    ...
    <div class="card-body">
      <p>
        With the key "1" you can speed up your movement if you unlock the
        ability in your skilltree
      </p>
      <p>
        With the key "2" you can slow down your movement if you unlock the
        ability in your skilltree
      </p>
      <p>
        With the key "3" you can remote ignition the nearest bomb if you unlock
        the ability in your skilltree
      </p>
    </div>
  </div>
