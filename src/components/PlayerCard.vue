  ...
  <div class="card card-default" v-if="dataLoad">
    ...
    <div class="card-body row gx-0">
      <div class="profile-pic col-4">
        <div v-if="player.img">
          <img :src="`/img/avatars/char_${player.img}.png`" alt="" style="height: 20vw; width: 20vw" />
        </div>
        <div v-else>
          <img src="/img/avatars/avatar_placeholder.png" alt="" style="height: 20vw; width: 20vw" />
        </div>
              ...
              <div class="modal-content" @click.stop="">
                ...
                <div class="modal-body">
                  <div v-for="image of images" :key="image" @click="changeImg(image)" data-bs-dismiss="modal">
                    <img :src="`/img/avatars/char_${image}.png`" alt="" />
                  </div>
                </div>
