    ...
    <div class="card" style="width: 75%; margin-top: 3rem">
      ...
      <div v-else>
        <div class="card-body">
          ...
          <div class="row">
            <div class="col-4">
              <img src="/img/placeholder_wappen_150.png" alt="placeholder" />
              <div v-if="!edit">
                {{ fleet.fleetInfo.public ? 'public' : 'private' }}
              </div>
              <div v-else>
                <label class="form-check-label" for="flexCheckDefault">
                  <input class="form-check-input shadow-none" v-model="fleet.fleetInfo.public" type="checkbox" value="" id="flexCheckDefault" />
                  public
                </label>
              </div>
            </div>
          ...
          <div class="modal-content">
            ...
            <div class="modal-body">
              ...
              <div class="form-check" style="margin-top: 1rem">
                <label class="form-check-label" for="flexCheckDefault">
                  <input class="form-check-input shadow-none" v-model="publicInput" type="checkbox" value="" id="flexCheckDefault" />
                  make fleet public
                </label>
              </div>
            </div>
      ...
      <div class="modal fade" id="skillModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog">
          <div class="modal-content">
            ...
            <div class="modal-body">
              <div data-title="you receive 1 point per 1.000.000 fleet score">{{ amountPoints() - usedSkillpoints }}/{{ amountPoints() }}</div>
