...
export function createEnemy(
  ...
  switch (getRandomInt(6)) {
    case 0:
      type = 'curve';
      imgsrc = '/img/char/enemy_space_debris1.gif';
      break;
    case 1:
      type = 'aimbot';
      imgsrc = '/img/char/enemy_komet.gif';
      break;
    case 2:
      type = 'chasebot';
    ...
    case 3:
      type = 'circle';
      imgsrc = '/img/char/enemy_rino_fish_spin.gif';
      break;
    case 4:
      type = 'random';
      imgsrc = '/img/char/enemy_blue-nebula.gif';
      timer = 900;
      break;
    case 5:
      type = 'spiral';
      imgsrc = '/img/char/enemy_satenna.gif';
      timer = 100;
      break;
  }
...
export function createItems(
  ...
  switch (getRandomInt(i) + (bossFight ? 2 : 0)) {
    ...
    case 3:
      type = 'magnet';
      imgsrc = '/img/items/magnet/magnet.png';
      size = (getRandomInt(25) + 20) * generalSize;
      break;
    case 4:
      type = 'slowEnemies';
      imgsrc = '/img/items/snowflake/snowflake.gif';
      size = (getRandomInt(25) + 20) * generalSize;
      break;
    case 5:
      type = 'stopTime';
      imgsrc = '/img/items/clock/clock.png';
      size = (getRandomInt(25) + 20) * generalSize;
      break;
    case 6:
      type = 'blackHole';
      size = 20 * percent(findSkill(player, 'smallerBlackHole'), 'de') * generalSize;
      imgsrc = '/img/items/darkhole/darkhole.png';
      break;
  }
  do {
