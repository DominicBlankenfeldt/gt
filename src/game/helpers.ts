...
export function findlvlWeaponUpgrade(
  player: type.Player,
  weaponUpgrade: type.LvlWeaponUpgradeName
) {
  return player.lvlTree.lvlWeaponUpgrade.find((c) => c.name == weaponUpgrade)!
    .lvl;
}
...
export function findWeaponUpgrade(
  player: type.Player,
  weaponUpgrade: type.WeaponUpgradeName
) {
  return player.weaponTree.weaponUpgrades[
    player.weaponTree.weaponUpgrades.findIndex((s) => s.name == weaponUpgrade)
  ].lvl;
}
export function findPassivUpgrade(
  player: type.Player,
  passivUpgrade: type.PassivUpgradeName
) {
  return player.passivTree.passivUpgrades[
    player.passivTree.passivUpgrades.findIndex((p) => p.name == passivUpgrade)
  ].lvl;
}
...
export function grow(
  object: type.PlayerInfo | type.Enemy,
